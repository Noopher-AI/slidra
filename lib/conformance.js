...
/**
 * @typedef {{ status: "ok" | "corrupt", error: string | null, steps: number, hidden: string[], triggers: Record<string, number>, enter: string, links: string[], title: string | null, lang: string | null }} SlideVerdict
