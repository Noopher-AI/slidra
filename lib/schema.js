...
// Node-only (it reads the schema files from disk); the browser viewer keeps
...
const read = (name) => JSON.parse(readFileSync(new URL(`../spec/schema/${name}`, import.meta.url), "utf8"));
...
export const VOCABULARY = Object.freeze(["effect", "transition", "notes", "comment", "chart", "series", "categories", "source", "element", "cell", "tspan"]);
