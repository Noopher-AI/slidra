...
import { DEFAULT_TRANSITION, EffectError, cssEscapeId, deriveSteps, enterTargets, validateEffect, validateTransition } from "./effects.js";
 ...
 *   links: Record<string, import("./links.js").Link>, warnings: string[]
 * }}
...
function readLinks(root, deck, path, warnings) {
  ...
  for (const el of root.querySelectorAll("[data-slidra-link]")) {
