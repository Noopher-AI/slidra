...
import { NAMESPACE } from "./viewer/deck.js";
...
export async function validateDeck(bytes, { fileName = "deck.slidra" } = {}) {
  ...
  if (deck.container === "zip") add("warning", "container-legacy-zip", `A legacy ZIP deck (formatVersion ${deck.project.formatVersion}); convert it to the SQLite container.`, "format §1.2");
