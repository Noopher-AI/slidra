// The slidra-validate command line: checks .slidra decks against the open
// format spec. bin/slidra-validate.mjs and the bundled validator
// (tools/build-bundle.mjs) both run it.
//
...
/**
 * Runs the slidra-validate command line.
 * @param {string[]} argv the arguments after the program name
 * @returns {Promise<number>} the exit status: 0 valid, 1 errors, 2 usage error
 */
export async function runValidateCli(argv) {
