...
範本就是一張 SVG，住在 `.comot` 裡，一份簡報可以有好幾份（封面一份、內頁一份、章節頁一份）。新增投影片時挑一份，**整份複製貼上**成為新投影片——從那一刻起，這張投影片自己擁有一切，與範本再無關係。**範本是死的。**
...
而母片提供的價值，在 CoMotion 裡大部分由 agent 承擔。PowerPoint 非得有母片不可，因為它的使用者只有滑鼠，改 30 頁底色是 30 次重複勞動；CoMotion 的使用者有 agent，那是一句話、30 條命令、一格復原。**用一整套繼承機制去買 agent 已經免費給你的東西，是很差的交易。**
