...
- `co-motion effect list <id> slides/001.svg` 回傳 2 個效果項：
...
- `co-motion cat <id> slides/001.svg` 可看到 `<comot:effect target="el-title" family="enter" effect="fade" start="on-click" .../>` 與對應的 `el-subtitle` 項。
