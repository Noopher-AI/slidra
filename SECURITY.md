...
Slidra is currently pre-1.0. Security fixes are made on the `main` branch and included in the next
release. Older releases are not maintained separately unless a release note explicitly says
otherwise.
