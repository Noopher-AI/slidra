//! `co-motion presentation canvas set <presentation-id> --width <n> --height <n>`.
...
fn set_presentation_canvas(id: &str, width: f64, height: f64) -> Result<(f64, f64), CoMotionError> {
