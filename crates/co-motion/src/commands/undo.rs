//! `co-motion undo <presentation-id> [extra...]`. Ported to Rust as one of
...
/// a confirmed, deliberate TS behaviour (`co-motion undo <id> extra`
...
mod tests {
    ...
    fn unknown_id_is_not_found() {
        // No CO_MOTION_HOME fixture is set up here; resolve_work_dir will
        // fail to find this id under whatever CO_MOTION_HOME happens to
