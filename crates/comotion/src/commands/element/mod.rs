...
//! `crate::element` (`crates/comotion/src/element/`), NOT here — this
...
mod tests {
    ...
    //! directly in-process against a temp `COMOTION_HOME`/work dir, proving
    ...
    fn temp_dir(label: &str) -> PathBuf {
        let dir = std::env::temp_dir().join(format!(
            "comotion-test-cmd-element-{label}-{}",
