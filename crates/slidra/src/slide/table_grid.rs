...
/// `data-slidra-type="table"`'s value (`TABLE_CONTAINER_TYPE` in the TS
...
const TABLE_SOURCE_TAG: &str = "slidra:source";
...
/// token in `data-slidra-cols`/`data-slidra-rows`.
///
...
/// real `data-slidra-cols`/`-rows` value this codebase ever writes is a plain
...
pub fn describe_table_shape_problem(container: &ScannedNode) -> Option<String> {
    let cols_raw = attribute_of(container, "data-slidra-cols").map(|a| a.value.as_str());
...
/// confirmed the container has well-formed `data-slidra-cols`/`-rows` — this
...
mod tests {
    ...
    fn valid_table_shape_has_no_problem() {
        let svg = r#"<g id="t1" data-slidra-type="table" data-slidra-cols="100 100" data-slidra-rows="40 40">
            <slidra:source src="assets/data/x.csv"/>
            <g data-slidra-cell="0,0"><rect/></g>
            <g data-slidra-cell="0,1"><rect/></g>
            <g data-slidra-cell="1,0"><rect/></g>
            <g data-slidra-cell="1,1"><rect/></g>
        </g>"#;
    ...
    fn missing_cols_or_rows_is_a_problem() {
        let svg = r#"<g id="t1" data-slidra-type="table" data-slidra-rows="40 40"><g data-slidra-cell="0,0"><rect/></g></g>"#;
        let container = table_container(svg);
        assert_eq!(
    ...
    fn non_numeric_cols_is_a_problem() {
        let svg = r#"<g id="t1" data-slidra-type="table" data-slidra-cols="a b" data-slidra-rows="40"><g data-slidra-cell="0,0"><rect/></g></g>"#;
        let container = table_container(svg);
        assert_eq!(
            describe_table_shape_problem(&container),
    ...
    fn cell_out_of_range_is_a_problem() {
        let svg = r#"<g id="t1" data-slidra-type="table" data-slidra-cols="100" data-slidra-rows="40"><g data-slidra-cell="0,5"><rect/></g></g>"#;
        let container = table_container(svg);
        assert_eq!(
            describe_table_shape_problem(&container),
    ...
    fn non_cell_child_is_a_problem() {
        let svg = r#"<g id="t1" data-slidra-type="table" data-slidra-cols="100" data-slidra-rows="40"><rect/></g>"#;
        let container = table_container(svg);
        assert_eq!(
            describe_table_shape_problem(&container),
    ...
    fn read_table_grid_extracts_cols_and_rows() {
        let svg = r#"<g id="t1" data-slidra-type="table" data-slidra-cols="100 200.5" data-slidra-rows="40 60"><g data-slidra-cell="0,0"><rect/></g></g>"#;
        let container = table_container(svg);
