...
/// a confirmed, deliberate TS behaviour (`slidra undo <id> extra`
...
mod tests {
    ...
    fn unknown_id_is_not_found() {
        // No SLIDRA_HOME fixture is set up here; resolve_work_dir will
        // fail to find this id under whatever SLIDRA_HOME happens to
