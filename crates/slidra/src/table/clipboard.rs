...
pub fn parse_cell_range(raw: &str) -> SlidraResult<CellRange> {
...
fn require_range_within_bounds(range: &CellRange, model: &TableModel) -> SlidraResult<()> {
