...
export function mountCanvas(container: HTMLElement): CanvasController {
  ...
  function handleSelectionMessage(message: SelectionMessage): void {
    ...
    if (message.event === "gesture-start") {
      ...
      if (message.kind === "move") gestures.beginMove(message.point);
      else if (message.kind === "marquee") gestures.beginMarquee(message.point);
      else if (message.kind === "scale" && isScaleHandle(message.handle)) gestures.beginScale(message.point, message.handle);
      else if (message.kind === "rotate") gestures.beginRotate(message.point);
      else if (message.kind === "textbox-width" && isTextboxHandle(message.handle)) gestures.beginTextboxWidth(message.point, message.handle);
    ...
    if (message.event === "gesture-move") {
      ...
      if (activeGesture?.kind === "move") gestures.updateMove(message.point, modifiers);
      else if (activeGesture?.kind === "marquee") gestures.updateMarquee(message.point);
      else if (activeGesture?.kind === "scale") gestures.updateScale(message.point, modifiers);
      else if (activeGesture?.kind === "rotate") gestures.updateRotate(message.point);
      else if (activeGesture?.kind === "textbox-width") gestures.updateTextboxWidth(message.point);
      if (
        activeGesture &&
    ...
    if (message.event === "gesture-end") {
      ...
      if (gesture?.kind === "move") void gestures.endMove(cancelled).then(settle);
      else if (gesture?.kind === "marquee") gestures.endMarquee(message.point, cancelled);
      else if (gesture?.kind === "scale") void gestures.endScale(message.point, cancelled).then(settle);
      else if (gesture?.kind === "rotate") void gestures.endRotate(message.point, cancelled).then(settle);
      else if (gesture?.kind === "textbox-width") void gestures.endTextboxWidth(message.point, cancelled).then(settle);
