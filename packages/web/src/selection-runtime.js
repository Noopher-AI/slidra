...
(function () {
   ...
   * (`data-comot-break="1"`) that has no DOM position at all. Only
  ...
  window.addEventListener(
    ...
    function (event) {
      ...
      // existing "group drill-in" two-dblclick sequence plan §4.4 asks for.
  ...
  /** `preview-textbox-width`: updates `data-comot-text-width` and the live-preview override the box/handles read — never touches `<text>`. */
