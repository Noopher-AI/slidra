...
// Matches the prototype's own layout math (plan §3.8) — size/weight/width
// are percentages of the canvas's own width; positions below (t/l) are
// computed against the ACTUAL open presentation's canvas size, never a
// hard-coded 1280×720.
...
/** Top offset is fixed at 42% of the canvas height; left depends on alignment (matches the prototype's own layout math, per plan §3.8). */
