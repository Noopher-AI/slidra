...
export function StatusBar({ state, controller }: StatusBarProps) {
  ...
  // Shows data-comot-name if present, otherwise falls back to id; a
  // multi-selection shows a count — this logic is preserved verbatim from
  // the old StatusBar.tsx, only the container class was renamed.
