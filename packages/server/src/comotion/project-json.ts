 ...
 * commands ever need. `comotion open`/`comotion new` already run the
 ...
 * `packages/core`'s `presentation.ts` / `crates/comotion/src/presentation.rs`
 ...
 * ever reads what `comotion` already validated moments earlier. The
