...
<rect x="80" y="176" width="720" height="440" fill="#F4F4F4" stroke="#BFBFBF"/><text x="440" y="400" font-size="24" fill="#777777" text-anchor="middle">圖表（chart）</text><text x="850" y="240" font-size="28" fill="#2E2E2E" font-weight="700">結論一句話</text><text x="850" y="300" font-size="24" fill="#777777">補充說明，說明這</text><text x="850" y="340" font-size="24" fill="#777777">張圖為什麼重要</text><text x="850" y="600" font-size="18" fill="#A0A0A0">資料來源</text>
