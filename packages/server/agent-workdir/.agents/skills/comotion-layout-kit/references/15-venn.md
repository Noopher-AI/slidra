...
<ellipse cx="510" cy="400" rx="260" ry="200" fill="#EDEDED" stroke="#BFBFBF" opacity="0.85"/><ellipse cx="790" cy="400" rx="260" ry="200" fill="#EDEDED" stroke="#BFBFBF" opacity="0.85"/><path d="M650 227a260 200 0 0 0 0 346a260 200 0 0 0 0-346z" fill="#DCDCDC" opacity="0.9"/><text x="330" y="410" font-size="24" fill="#777777" text-anchor="middle">只有 A</text><text x="970" y="410" font-size="24" fill="#777777" text-anchor="middle">只有 B</text><text x="650" y="406" font-size="24" fill="#2E2E2E" font-weight="700" text-anchor="middle">共有</text><text x="650" y="640" font-size="20" fill="#A0A0A0" text-anchor="middle">交集的一句說明</text>
