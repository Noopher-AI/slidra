...
**Mood**: Ten undulating curves arranged in parallel with alternating phases. Like a sound wave or woven fabric — soft and regular.

**Suited for**: `dense`, `anchor`.
**Not suited for**: Pages that need to be absolutely quiet.

**Suggested opacity**: 0.55

**Technique**: Each line uses continuous quadratic Béziers, with adjacent lines at opposite phase.

Full SVG: see `oscillate.svg` in the same folder.
