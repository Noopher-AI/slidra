...
description: 從 47 種背景配方裡挑一種建成 SVG 資產並套到頁面，每種都附完整 SVG、適合的節奏與搭配的風格，用一句話描述想要的氣氛就模糊匹配；也負責移除背景。作者的訊息以 /comotion-background-kit 開頭、或 comotion-plan／comotion-build 要挑背景配方時用
---
