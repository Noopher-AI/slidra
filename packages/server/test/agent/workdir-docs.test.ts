...
describe("[NOOP-236] shipped work directory documentation", () => {
  it("has exactly the eleven shipped skills, each well-formed, and reported by collectSlashCommands (A2/A3/A6)", async () => {
    ...
    expect(dirNames.sort()).toEqual(["comotion-animate", "comotion-build", "comotion-chart", "comotion-check", "comotion-new-slide", "comotion-notes", "comotion-plan", "comotion-reshape", "comotion-style", "comotion-table", "comotion-validate"]);
    ...
    try {
      ...
      expect(commands.map((c) => c.name)).toEqual(["comotion-animate", "comotion-build", "comotion-chart", "comotion-check", "comotion-new-slide", "comotion-notes", "comotion-plan", "comotion-reshape", "comotion-style", "comotion-table", "comotion-validate"]);
