...
export function TableSkeletonSection() {
  return (
    <fieldset className="style-section style-section-skeleton" data-section="table">
      <legend>Table</legend>
      <p className="style-section-note">Table elements are not supported yet; this section is layout preview only</p>
...
export function ChartSkeletonSection() {
  return (
    <fieldset className="style-section style-section-skeleton" data-section="chart">
      <legend>Chart</legend>
      <p className="style-section-note">Chart elements are not supported yet; this section is layout preview only</p>
  ...
  return (
    <fieldset className="style-section style-section-skeleton" data-section="image">
      ...
      <label className="style-field" data-attr="image-caption">
        ...
        <input type="text" data-attr="image-caption" disabled value="" placeholder="Not supported yet" />
      </label>
    </fieldset>
  );
}
